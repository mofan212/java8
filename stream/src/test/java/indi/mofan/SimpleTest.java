...
import indi.mofan.domain.util.NumberConversionUtil;
...
public class SimpleTest {
    ...
    public void testCompress() {
        String source = "com.seeyon.cip.connector.dynamic.dto.Seeyon_BPM.GetMemberInfoByCodeParameterDto";
        byte[] bytes = DigestUtil.md5(source);
        System.out.println(DigestUtil.md5Hex(source));
        // IchYID7mjLs539GavLVQe
        System.out.println(NumberConversionUtil.get62(bytes));
    }
